...
const page = () => {
  return (
    <div className="my-6 flex flex-col items-center justify-center">
      <div className="text-xl py-4 font-main">Day 04: Progressive Input Stack</div>
      <div className="relative w-80 h-80 sm:w-96 sm:h-96 p-6 bg-gray2 flex justify-center items-center rounded-3xl block-shadow">
